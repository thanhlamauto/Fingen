...
\begin{table*}[t]
    ...
    $\sigma=3.0$ to the corresponding FPGAN-Control table entries.}
    \label{tab:sd302_tar1_backbones}
    \begin{tabular}{lcccc}
        \toprule
        Training dataset & Res18 & Res50 & Mob50 & ViT-S \\
        \midrule
        Real data & 91.75 & 92.41 & 92.54 & 94.48 \\
        StyleGAN2 & 24.22 & 5.98 & 28.07 & 4.98 \\
        PrintsGAN & 70.67 & 70.23 & 72.58 & 70.14 \\
        FPGC-0 & 87.54 & 87.18 & 87.54 & 84.37 \\
        Ours &  &  &  &  \\
        \bottomrule
    \end{tabular}
\end{table*}
