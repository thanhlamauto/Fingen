...
\begin{table*}[t]
    ...
    identity.  Values are TAR@FAR=$1\%$ on the SD302A test split.}
    \label{tab:sd302_tar1_backbones}
    \begin{tabular}{lcccc}
        \toprule
        Training dataset & Res18 & Res50 & Mob50 & ViT-S \\
        \midrule
        Real data & \TODO{fill} & \TODO{fill} & \TODO{fill} & \TODO{fill} \\
        StyleGAN2 & \TODO{fill} & \TODO{fill} & \TODO{fill} & \TODO{fill} \\
        PrintsGAN & \TODO{fill} & \TODO{fill} & \TODO{fill} & \TODO{fill} \\
        FPGC-0 & \TODO{fill} & \TODO{fill} & \TODO{fill} & \TODO{fill} \\
        Ours & \TODO{fill} & \TODO{fill} & \TODO{fill} & \TODO{fill} \\
        \bottomrule
    \end{tabular}
\end{table*}
