...
1 samples a fingerprint identity in a compressed VQ-VAE latent space while
conditioning on a mean-pooled ConvNeXt style descriptor computed from reference
images of the target sensor.  Stage 2 turns the generated identity into multiple
