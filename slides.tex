  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.50\textwidth}
      ...
      \begin{block}{Trainable per new sensor}
        Rank-8 LoRA only on Stage-2 UNet middle self-attention
        $qkv$ and output projection.
      \end{block}
    \end{column}
    \begin{column}{0.47\textwidth}
      \begin{itemize}
        \item Trainable LoRA: \key{12.3K parameters}.
    ...
    \begin{column}{0.47\textwidth}
      \begin{block}{Key ablation numbers}
        \begin{itemize}
          ...
          \item Selected LoRA: mid-attn $qkv$ + proj, 12.3K params.
        \end{itemize}
      \end{block}
    \end{column}
  \end{columns}
...
\begin{frame}{Efficiency and Practicality}
  ...
  \resizebox{0.80\linewidth}{!}{%
    \begin{tabular}{lrlr}
      ...
      \midrule
      Trainable LoRA / sensor & \textbf{12.3K} & Logged generation & 1.05 s/image \\
      \bottomrule
    \end{tabular}}
  \vspace{0.9em}
  \begin{itemize}
    ...
    \item New sensor adaptation trains only LoRA; no full generator retraining.
  \end{itemize}
\end{frame}
...
\begin{frame}{Limitations}
  \begin{itemize}
    ...
    \item Fixed rank-8 LoRA can be insufficient for low-contrast sensors such as
    DB2; it may learn tone but weaken ridge/valley separation.
...
\begin{frame}{Takeaways}
  \begin{block}{Main result}
    ...
    unseen sensor styles with only 12.3K trainable LoRA parameters per sensor.
  \end{block}
  \begin{itemize}
    ...
    \item Low-contrast sensors remain the main failure mode.
  \end{itemize}
\end{frame}
